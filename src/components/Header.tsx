    ...
    <>
      ...
      >
        <div className="max-w-screen-2xl mx-auto px-6 md:px-12 lg:px-16 py-6 flex justify-between items-center">
          ...
          {/* Logo — profile photo with M.G overlay */}
          <Link
            to="/"
            onClick={() => setIsOpen(false)}
            className="group flex items-center gap-3 hover:opacity-80 transition-opacity duration-300"
          >
            <div className="relative w-9 h-9 rounded-full overflow-hidden border border-primary/40 group-hover:border-primary transition-colors duration-300 shrink-0">
              <img
                src="/projects/profile.jpeg"
                alt="M.G"
                className="w-full h-full object-cover object-top grayscale-[15%]"
              />
              {/* M.G overlay — fades in on hover */}
              <div className="absolute inset-0 bg-black/60 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                <span className="text-[9px] font-light tracking-[0.2em] text-white uppercase">M.G</span>
              </div>
            </div>
            <span className="text-sm font-light tracking-[0.25em] text-primary uppercase hidden sm:block">
              M.G
            </span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <div className="flex items-center gap-4">
              <Link to="https://www.linkedin.com/in/mugwaneza-g-230178242/" target="_blank" rel="noopener noreferrer"
              ...
              <Link to="https://github.com/Gasorekibo" target="_blank" rel="noopener noreferrer"
            ...
            <div className="flex justify-between items-center px-6 py-6 border-b border-[var(--border)]">
              <div className="flex items-center gap-3">
                <div className="relative w-8 h-8 rounded-full overflow-hidden border border-primary/40 shrink-0">
                  <img src="/projects/profile.jpeg" alt="M.G" className="w-full h-full object-cover object-top grayscale-[15%]" />
                </div>
                <span className="text-sm font-light tracking-[0.25em] text-primary uppercase">M.G</span>
              </div>
              <button
                onClick={() => setIsOpen(false)}
